const naukariServices = [
  {
    title: "Resume Display",
    benefit: "Increase your Profile Visibility to recruiters up to 3 times.",
    description:
  ...
  },
  {
    ...
    benefit: "Personalized AI driven mock interviews for your profile",
    description:
  ...
  {
    title: "Jobs For You",
    benefit: "Stand out as an Early Applicant with instant access to jobs.",
    description:
  ...
  },
  {
    ...
    benefit: "Send personalized message to recruiters",
    description:
  ...
  },
  {
    ...
    benefit: "Get your resume reviewed and improve your job application",
    description:
